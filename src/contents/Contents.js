import MintPhoto1 from "../assets/MintPhoto1.png";
...
export const homeContent = {
  bundle: {
    ...
    title: "MULTİDİSİPLİNER İNOVASYON TEKNOLOJİLERİ KULÜBÜ",
    statistics: [
      { number: "1000+", text: "ÜYE" },
      { number: "50+", text: "EĞİTİM" },
      { number: "10+", text: "ZİRVE" },
    ],
  },
  aboutUs: {
    aboutUs:
